  ...
  return (
    <Layout>
      <section className="py-20 text-center max-w-xl mx-auto">
        ...
        <p className="text-gray-600 mb-4">Come see us or get in touch.</p>

        <div className="mb-6">
          <p><strong>Address:</strong> 3 Station Rd, Bognor Regis PO21 1QB</p>
          <p><strong>Phone:</strong> <a href="tel:01243941281" className="underline">01243 941281</a></p>
          <p><strong>Instagram:</strong> <a href="https://instagram.com/buzz.and.fade" className="underline">buzz.and.fade</a></p>
        </div>
